...
% Titulos de capítulo mejorados
\usepackage{titlesec}
\titleformat{\chapter}[hang]{\normalfont\huge\bfseries}{\thechapter}{20pt}{\huge}

% Comando para la fuente por defecto
...
% stretchable space between characters for better break URLs
% see https://github.com/plk/biblatex/issues/850
...
\unsure{Este es un comentario sin resolver.}
\change[inline]{Este es un comentario que necesita ser cambiado.}
\info{Este es un comentario informativo.}
\improvement{Este es un comentario que necesita ser mejorado.}
\thiswillnotshow{Este comentario no se mostrará.}
